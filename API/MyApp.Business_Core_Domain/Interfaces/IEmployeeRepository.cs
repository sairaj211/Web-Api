...
namespace MyApp.Business_Core_Domain.Interfaces
{
    public interface IEmployeeRepository
    {
        ...
        Task<bool> EmailExistsAsync(string email, Guid currentEmployeeId,CancellationToken cancellationToken);
        Task<bool> PhoneExistsAsync(string phone, Guid currentEmployeeId, CancellationToken cancellationToken);
    }
}
